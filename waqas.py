...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;96m[☆] \x1b[1;97m ID \x1b[1;96m>>>> ")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;96m[☆] \x1b[1;97musername\x1b[1;96m>>>> ")
...
def pilih_super():
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;32;40m[✺] W03170424820W\033[1;95m"+o),;sys.stdout.flush();time.sleep(1)
